...
Лицензия - GPL v2. Для работы с исходниками MultiPoints вам понадобятся:
  * Компилятор джавы JDK. В линуксе пакет называется openjdk-6-jdk. В винде надо залезть на сайт и пытаться выбрать версию jdk без нахлобучек и доп.пакетов, мегов на 20-30.
  * IDE. Я лично использую для разработки eclipse http://eclipse.org
  * система контроля версий git http://git-scm.com/
  * средство сборки проектов Ant http://ant.apache.org
