...
public void paintFrame(PointsAI pointsAI){
...
public boolean isMoveByWLTTemplate(PointsAI pointsAI,int x,int y,int smaller){
	String content=TemplateType.WALL.getContent(pointsAI.game, x, y,false);
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL,null)){//System.out.println("wlt");
		//try{if(pointsAI.pointsTE!=null)pointsAI.pointsTE.moveFromAI(content,0);}catch(Exception e){}
