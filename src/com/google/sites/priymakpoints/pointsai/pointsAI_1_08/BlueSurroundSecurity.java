...
public Point getAIcoordinatesFromBSSbase(PointsAI pointsAI){	
	...
	while(it.hasNext()){
		...
		//new EngineFrame(e);
		if(e.getBlueScore()>0){
			//System.out.println("applicapable and return = "+point_RED_PROTECTION.x+";"+point_RED_PROTECTION.y);
			return point_RED_PROTECTION;
		}
		else {
			//System.out.println("no applicapable");
		}
	}
return null;
}
...
private void getAIcoordinatesFromBST(String content,PointsAI pointsAI){
	...
	//System.out.println("score "+e.getBlueScore()+";"+e.getRedScore());
