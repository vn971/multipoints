...
public boolean isMoveByWall(PointsAI pointsAI){
	...
	else if(smaller==1){x=w1.x;y=w1.y;}
	else if(smaller==2){x=w2.x;y=w2.y;}
	else if(smaller==3){x=w3.x;y=w3.y;}
		
	if(isMoveByWallTemplates(pointsAI,x,y,smaller)){return true;}
...
public boolean isMoveByWallTemplates(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(x<8&y<8){if(isMoveByWCTTemplateLT(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}//move by corner
	else if(x>32&y<8){if(isMoveByWCTTemplateRT(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}//move by corner
	else if(x<8&y>25){if(isMoveByWCTTemplateLB(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}//move by corner
	else if(x>32&y>25){if(isMoveByWCTTemplateRB(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}//move by corner
	if(x<8){if(isMoveByWSTTemplateL(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}	
	else if(x>32){if(isMoveByWSTTemplateR(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}
	else if(y<8){if(isMoveByWSTTemplateT(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}	
	else if(y>25){if(isMoveByWSTTemplateB(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}
	else{if(isMoveByWLTTemplate(pointsAI,x,y,smaller)){addMakros(pointsAI,x,y);return true;}}
	return false;
}

void addMakros(PointsAI pointsAI,int x,int y){
	pointsAI.moveAI.addMakros(pointsAI, false, pointsAI.base.getTemplate(foundedNumber).getTemplateIndex(),foundedNumber,x,y);
}
...
boolean isMoveByWLTTemplate(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall";return true;
		}
	}
	return false;
}
...
boolean isMoveByWCTTemplateLT(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_CORNER)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall corner left top";return true;
		}
	}
	return false;
}
...
boolean isMoveByWCTTemplateRT(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_CORNER)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall corner right top";return true;
		}
	}
	return false;
}
...
boolean isMoveByWCTTemplateLB(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_CORNER)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall corner left bottom";return true;
		}
	}
	return false;
}
...
boolean isMoveByWCTTemplateRB(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_CORNER)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall corner right bottom";return true;
		}
	}
	return false;
}
...
boolean isMoveByWSTTemplateL(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_SIDE)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall side left";return true;
		}
	}
	return false;
}
...
boolean isMoveByWSTTemplateR(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_SIDE)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall side right";return true;
		}
	}
	return false;
}
...
boolean isMoveByWSTTemplateT(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_SIDE)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall side top";return true;
		}
	}
	return false;
}
...
boolean isMoveByWSTTemplateB(PointsAI pointsAI,int x,int y,int smaller){
	...
	if(pointsAI.base.isFoundArea(content,TemplateType.WALL_SIDE)){
		...
		if(pointsAI.moveAI.isAImove(pointsAI,moveAIx,moveAIy)){
			pointsAI.moveAI.strLastMove="wall side bottom";return true;
		}
	}
	return false;
}
